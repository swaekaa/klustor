...
export default function PlayerCar({ groupRef, textures, speed = 0, steering = 0, position = [0, 0, 0], color = '#C8D8E8' }: PlayerCarProps) {
  ...
  return (
    <group ref={actualGroupRef} position={position}>
      ...
      <mesh position={[0, 0.22, 1.65]} rotation={[-0.05, 0, 0]} material={bodyMat}>
        <boxGeometry args={[1.9, 0.43, 1.2]} />
      </mesh>

      {/* Rear Trunk (sloped slightly) */}
      <mesh position={[0, 0.26, -1.55]} rotation={[0.02, 0, 0]} material={bodyMat}>
      ...
      {/* === BUMPERS & TRIM === */}
      {/* Front Bumper */}
      <mesh position={[0, 0.05, 2.26]} material={darkMat}>
        <boxGeometry args={[1.95, 0.15, 0.15]} />
      </mesh>
      {/* Rear Bumper */}
      <mesh position={[0, 0.08, -2.06]} material={darkMat}>
        <boxGeometry args={[1.95, 0.15, 0.15]} />
      </mesh>
      {/* Side Molding Line */}
      <mesh position={[0.96, 0.25, 0]} material={darkMat}>
      ...
      {/* Side Skirts */}
      <mesh position={[0.96, 0.0, 0.05]} material={darkMat}>
      ...
      {/* Front License Plate */}
      <mesh position={[0, 0.05, 2.34]} material={whiteMat}>
      ...
      {/* Exhaust Pipe */}
      <mesh position={[0.65, -0.02, -2.15]} rotation={[Math.PI / 2, 0, 0]} material={hubMat}>
      ...
      {/* Roof */}
      <mesh position={[0, 0.95, -0.2]} material={bodyMat}>
        <boxGeometry args={[1.65, 0.05, 1.2]} />
      </mesh>

      {/* Windshield */}
      <mesh position={[0, 0.73, 0.6]} rotation={[0.55, 0, 0]} material={glassMat}>
        <boxGeometry args={[1.6, 0.6, 0.05]} />
      </mesh>

      {/* Rear Window */}
      <mesh position={[0, 0.73, -0.95]} rotation={[-0.45, 0, 0]} material={glassMat}>
        <boxGeometry args={[1.6, 0.55, 0.05]} />
      </mesh>

      {/* Side Windows (Dark Glass) */}
      <mesh position={[0.83, 0.72, -0.2]} material={glassMat}>
      ...
      {/* B-Pillars (Middle) */}
      <mesh position={[0.84, 0.72, -0.2]} material={bodyMat}>
